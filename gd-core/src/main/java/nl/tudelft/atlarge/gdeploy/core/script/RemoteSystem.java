...
public enum RemoteSystem {
    ...
    public String scripts() {
        return preferredDeployerDirectory + Global.SCRIPT_DIRECTORY + Global.CURRENT_PROJECT + '/';
    }

    public String resources() {
        return preferredDeployerDirectory + Global.OUTPUT_RESOURCES + Global.CURRENT_PROJECT + '/';
    }
